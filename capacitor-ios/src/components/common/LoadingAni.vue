<template>
  <div class="loading-container">
    <svg class="wave-spinner" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

      <rect x="1" y="1" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="8.33" y="1" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="1" y="8.33" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="15.66" y="1" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="8.33" y="8.33" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="1" y="15.66" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="15.66" y="8.33" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="8.33" y="15.66" width="7.33" height="7.33" fill="#FFFFFF">
      ...
      <rect x="15.66" y="15.66" width="7.33" height="7.33" fill="#FFFFFF">
...
.wave-spinner {
  width: 48px;
  height: 48px;
  filter: drop-shadow(0 2px 4px rgba(38, 51, 222, 0.3));
}

/* Reduced motion support */
@media (prefers-reduced-motion: reduce) {
  .wave-spinner animate {
